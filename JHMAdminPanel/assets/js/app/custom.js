...
$(function(){
	...
	********************************/
	if( $.isFunction($.fn.datetimepicker) ){
		...
		$('#datepicker').datetimepicker({pickTime: false}); $('#datepicker1').datetimepicker({pickTime: false});
		
		$('#timepicker').datetimepicker({pickDate: false}); $('#timepicker1').datetimepicker({pickDate: false});
