				...
				<div class="panel-body">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="toggleColumn-datatable">
						...
						<tbody>
							...
							(SELECT COUNT(toi.order_item_id) FROM tbl_order_item toi WHERE toi.order_id = ord.order_id and toi.isbackOrd=1) AS items
							FROM tbl_order ord
							...
							?>
								<tr <?php if($i%2 == 0){ echo 'class="info"'; } ?>>
									...
									<td>
                                        ...
                                        <?php }if($canChangeToConfirm) { ?>
                                            <button type="button" onClick="changeToConfirmed(<?php echo $orderId; ?>, 'Do you want to change this order to confirmed order?')" class="btn btn-success btn-xs">Change To Confirmed Order</button>
                                        <?php }?>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-bordered mytable orderItemTable">
                                        ...
                                        while($oiRow = mysqli_fetch_object($oiRs)){
                                            ...
                                            $priceGst = ($priceFull * $gst) / 100;
                                            $price = $priceFull - $priceGst;
                                        ...
                                        <tr>
                                            ...
                                            <td>$ <?php echo formatCurrency($gTotal); ?></td>
                                        </tr>
                                        <tr>
...
function changeToConfirmed(id, msg){ 
    if(confirm(msg)){
        $.get('change_to_confirmed.php', {'order_id' : id}, function(data){
            alert(data); location.reload();
        });
    }
}
