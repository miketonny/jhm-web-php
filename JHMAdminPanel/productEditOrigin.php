				...
				<div class="tab-content" id="myTabContent">
                	...
                	<div id="product" class="tab-pane tabs-up fade in active panel panel-default">
						...
						<form method="post" class="form-horizontal" action="admin_action_model.php" enctype="multipart/form-data" onsubmit="return chkFormData();">
							...
							<div class="form-group" style="display:none;">
								...
								<div class="col-sm-2">
									<input class="form-control inputmask" required name="qty" placeholder="Qty Available" type="text" data-inputmask="'alias': 'decimal', 'autoGroup': true" style="text-align:left;" value="<?php echo $pro->qty; ?>" />
								</div>
							</div>
							<hr/>
							<div class="form-group">
					...
					<div id="detail" class="tab-pane tabs-up fade panel panel-default">
                    	...
                    	<div class="panel-body">
							...
							$i = 1;
							$colorNotGet = '';
							$rsProColor = exec_query("SELECT tpc.*, tpp.product_price, tpp.product_rrp, tpp.product_upc FROM tbl_product_color tpc
							...
							while($rowProColor = mysql_fetch_object($rsProColor)){
								$colorNotGet .= ($colorNotGet == '')?"'".$rowProColor->color_code."'":",'".$rowProColor->color_code."'";
							?>
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading" style=" background:<?php echo $rowProColor->color_code; ?>; ">Edit Product Detail (<?php echo $color = getColor($rowProColor->color_code, $con)->color; ?>)</div>
									<div class="panel-body">
			...
			<div class="modal-body">
					...
					<div class="form-group" style="margin:0 auto; padding:7px;">
						<div  id="colorpallet">
							...
							$condi = ($colorNotGet != '')?"AND color_code NOT IN($colorNotGet)":'';
